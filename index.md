...
- You use machine and human-readable paths (i.e. no spaces, special
  ...
  ([`reuseme::rename_files2()`](https://olivroy.github.io/reuseme/reference/rename_files2.md)),
...
This will enable functions like
...
In interactive sessions, you can use the
[`screenshot()`](https://olivroy.github.io/reuseme/reference/screenshot.md)
function to access an image in the clipboard and save it as .png in a
`figures/` or `images/`directory in your RStudio project.

reuseme helps you work across projects, with the
[`proj_switch()`](https://olivroy.github.io/reuseme/reference/proj_switch.md)
function.
[`proj_switch()`](https://olivroy.github.io/reuseme/reference/proj_switch.md)
works a lot like
...
If you want to work across projects with
[usethis](https://olivroy.github.io/reuseme/usethis.r-lib.org), you need
to provide the full path to a project. With reuseme, just use the
project name!
...
Due to the growing number of criteria, regex,
